...
--
-- Host: localhost:3306
-- Generation Time: Nov 15, 2024 at 07:21 AM
...
CREATE TABLE `users` (
  ...
  `level` enum('dosen','dpa','kps','mahasiswa','tendik','komite disiplin','bk','admin') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

...
<script>
    $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('admin.SecurityDeposit.index') }}',
                    data: function(data) {
            ...
            $('body').on('click', '.editPost', function() {
                var id = $(this).data('id');
                $.get("{{ route('admin.SecurityDeposit.index') }}" + '/' + id + '/edit', function(data) {
            ...
            $('#simpandata').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.SecurityDeposit.store') }}",
                    type: "POST",
                    dataType: 'json',
            ...
            $('body').on('click', '.deletePost', function() {
                ...
                if (confirm("Apakah anda yakin ingin menghapus data ini ? ")) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('admin.SecurityDeposit.store') }}" + '/' + id,
                        success: function(data) {

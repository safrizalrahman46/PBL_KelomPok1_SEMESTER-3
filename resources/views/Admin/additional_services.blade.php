...
<script>
    $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('additional_servicess.index') }}',
                    data: function(data) {
            ...
            $('#createNewPost').click(function() {
                ...
                $('#modelHeading').html("Add Additional Services");
                $('#ajaxModelexa').modal('show');
            });

            $('body').on('click', '.editPost', function() {
                var id = $(this).data('id');
                $.get("{{ route('additional_servicess.index') }}" + '/' + id + '/edit', function(data) {
                    $('#modelHeading').html("Edit Addtional Services");
            ...
            $('#simpandata').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('additional_servicess.store') }}",
                    type: "POST",
                    dataType: 'json',
            ...
            $('body').on('click', '.deletePost', function() {
                ...
                if (confirm("Apakah anda yakin ingin menghapus data ini ? ")) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('additional_servicess.store') }}" + '/' + id,
                        success: function(data) {
                            $.getScript('{{ asset('/public/notify.min.js') }}', function() {

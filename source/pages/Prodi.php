    ...
    $(document).ready(function() {
        ...
        tabelData = $('#table-data').DataTable({
            ...
            buttons: [{
                ...
                title: "Data Prodi", // Title of the sheet (header)
                filename: function() {
                    ...
                    return "Export_Data_Prodi_" + dateString; // This will set the file name
                },
                exportOptions: {
                    columns: [0, 1] // Only export visible columns
                }
            }],
            customize: function(xlsx) {
                var sheet = xlsx.xl.worksheets['sheet1.xml'];

                // Change the first row (header) to "Data Prodi"
                var headerRow = sheet.getElementsByTagName('row')[0]; // First row (header row)
                headerRow.firstChild.textContent = "Data Prodi"; // Set the header text to "Data Prodi"
